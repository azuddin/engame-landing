    ...
    <Section>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-10 py-6">
        <div className="border-b-2 pt-10 pb-16 md:py-0 md:border-0 flex flex-col items-center md:items-start space-y-2">
          ...
          <p className="font-montserrat text-lg md:text-sm">
        ...
        <div className="flex flex-col space-y-4 text-center md:text-left">
          <div>
            ...
            <p className="font-montserrat font-bold text-lg md:text-sm">
              contact@engame.asia
            </p>
          </div>
          <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center border-t-2 py-8 md:py-4 space-y-4 md:space-y-0">
        ...
        <div className="menu md:space-x-4 flex flex-col md:flex-row space-y-4 md:space-y-0">
          <Link href="/our-story" passHref>
            <button className="font-lato font-bold text-lg md:text-sm">
              Our Story
            </button>
          </Link>
        ...
        <div className="term md:space-x-4 flex flex-col md:flex-row space-y-4 md:space-y-0">
